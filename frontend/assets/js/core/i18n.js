...
const I18N = {
  fr: {
    ...
    'svc.desc': "De la conception d'applications à l'accompagnement financier, en passant par la communication interne et le matériel — BL∞MAR ONE couvre toute la chaîne de valeur numérique des entreprises africaines.",
    'svc.tag1': '01 · B.one Payment',
    'svc.tag2': '02 · Web & Mobile',
    'svc.tag3': '03 · Accompagnement',
    'svc.tag4': '04 · B.one ProCom',
    ...
    'svc.s4.li3': 'Annonces, notifications et partage de fichiers',
    'svc.s4.li4': "Intégration à l'écosystème Bloomarone (RH, opérations, direction)",
  ...
  en: {
    ...
    'svc.s4.li3': 'Announcements, notifications and file sharing',
    'svc.s4.li4': 'Integration with the Bloomarone ecosystem (HR, operations, leadership)',
