...
const I18N = {
  fr: {
    ...
    'hero.badge': 'Infrastructure financière numérique et opérationnelle des PME au Cameroun',
    'hero.title1': 'Votre croissance,',
    'hero.title2': 'propulsée par le digital.',
    'hero.subtitle': "Prenez les commandes de votre croissance. Pilotez votre PME avec la clarté d'un grand groupe.",
    'hero.desc1': 'Chez <strong class="text-bloomar-navy font-semibold">BL∞MAR ONE</strong>, vous gérez votre business, pas la paperasse. Que vous teniez un restaurant, un hôtel, une boutique, un cabinet ou une école, nous créons des outils digitaux vraiment adaptés à nos réalités quotidiennes.',
    'hero.desc2': 'Ne subissez plus votre gestion financière. Utilisez le simulateur ci-contre pour projeter vos marges et découvrez comment Bloomar One transforme vos données quotidiennes en leviers de décision.',
    'hero.benefit1.title': 'Des applis simples',
    'hero.benefit1.desc': 'Suivez caisse, compta, stocks et équipes en quelques clics depuis un ordinateur ou téléphone mobile.',
    'hero.benefit2.title': 'Automatisations',
    'hero.benefit2.desc': 'Nous automatisons vos tâches répétitives pour libérer votre temps.',
    'hero.benefit3.title': 'SAV fiable',
    'hero.benefit3.desc': 'Une équipe humaine, proche et réactive, vous accompagne au quotidien.',
    'hero.quote': '« Votre business mérite mieux que des approximations. Il mérite du contrôle. »',
    'hero.cta1': "Tester l'accès gratuit de 14 jours",
    'hero.cta2': 'Découvrir la démo interactive',
    'hero.revenue': "Chiffre d'Affaires",
    'hero.expenses': 'Dépenses Total',
    'hero.profit': 'Bénéfice Net',
    'hero.graph.revenue': "Chiffre d'Affaires Cumulé",
    'hero.graph.breakEven': 'Seuil de Rentabilité (Point Mort)',
    'hero.month1': 'Mois 1',
    'hero.month2': 'Mois 2',
    'hero.month3': 'Mois 3',
    'hero.monthCurrent': 'Mois Actuel',
    'hero.simulator': "Simulateur d'Activité (Volume Caisse)",
    'hero.simulatorBase': '100% (Base)',
    ...
    'contact.opt1': 'Solutions Web & Mobile sur Mesure',
    'contact.opt2': 'Accompagnement, Structuration & Croissance',
    'contact.opt3': 'Service Après-Vente (SAV)',
  ...
  en: {
    ...
    'hero.badge': 'Digital financial and operational infrastructure for SMEs in Cameroon',
    'hero.title1': 'Your growth,',
    'hero.title2': 'powered by digital.',
    'hero.subtitle': 'Take control of your growth. Run your SME with the clarity of a large group.',
    'hero.desc1': 'At <strong class="text-bloomar-navy font-semibold">BL∞MAR ONE</strong>, you manage your business, not paperwork. Whether you run a restaurant, hotel, shop, firm or school, we build digital tools truly adapted to daily realities.',
    'hero.desc2': 'Stop struggling with financial management. Use the simulator to project your margins and see how Bloomar One turns daily data into decision levers.',
    'hero.benefit1.title': 'Simple apps',
    'hero.benefit1.desc': 'Track cash, accounting, inventory and teams in a few clicks from computer or mobile.',
    'hero.benefit2.title': 'Automation',
    'hero.benefit2.desc': 'We automate repetitive tasks to free up your time.',
    'hero.benefit3.title': 'Reliable support',
    'hero.benefit3.desc': 'A human, responsive team supports you every day.',
    'hero.quote': '"Your business deserves better than guesswork. It deserves control."',
    'hero.cta1': 'Try 14-day free access',
    'hero.cta2': 'Explore interactive demo',
    'hero.revenue': 'Revenue',
    'hero.expenses': 'Total Expenses',
    'hero.profit': 'Net Profit',
    'hero.graph.revenue': 'Cumulative Revenue',
    'hero.graph.breakEven': 'Break-even Point',
    'hero.month1': 'Month 1',
    'hero.month2': 'Month 2',
    'hero.month3': 'Month 3',
    'hero.monthCurrent': 'Current Month',
    'hero.simulator': 'Activity Simulator (Cash Volume)',
    'hero.simulatorBase': '100% (Base)',
    ...
    'contact.opt1': 'Custom Web & Mobile Solutions',
    'contact.opt2': 'Support, Structuring & Growth',
    'contact.opt3': 'After-Sales Service (Support)',
