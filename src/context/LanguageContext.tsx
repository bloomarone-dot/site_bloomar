...
const SERVICES_FR: ServiceItem[] = [
  ...
  },
  {
    ...
    tagline: 'Assistance technique, formation et conseil',
    ...
    features: [
      'Support en cas de panne ou dysfonctionnement',
      'Mise en place des outils & Prise en main par vos équipes',
      'Recommandations pratiques pour optimiser vos outils et process',
      'Conseil stratégique',
    ],
...
const SERVICES_EN: ServiceItem[] = SERVICES_FR.map(s => ({ ...s }))
...
const fr: T = {
  ...
  marquee: ['Solutions Web & Mobile', 'Accompagnement', 'SAV', 'Les Indispensables', 'MoMo & Orange Money', 'Python · React · Node.js'],
  services: {
  ...
  footer: {
    ...
    servicesList: ['Solutions Web & Mobile', 'Accompagnement', 'Service Après-Vente', 'Les Indispensables'],
  ...
  form: {
    ...
    close: 'Fermer',
    services: ['Solutions Web & Mobile sur Mesure', 'Accompagnement', 'Service Après-Vente', 'Les Indispensables', 'Autre'],
  ...
  contact: {
    ...
    sub: "Que vous ayez une idée précise ou un simple besoin de conseil, notre équipe est là pour vous guider.",
  ...
  about: {
    ...
    values: [
      ...
      { icon: '🤝', title: 'Proximité', desc: 'Joignables sur WhatsApp, , joignable 24//24.' },
      { icon: '🚀', title: 'Excellence', desc: 'Chaque projet est livré avec soin, dans les délais,formation incluse.' },
    ],
    ...
    ctaSub: 'Votre projet mérite une équipe qui comprend vos realite .',
...
const en: T = {
  ...
  marquee: ['Web & Mobile Solutions', 'Consulting', 'After-Sales Service', 'The Essentials', 'MoMo & Orange Money', 'Python · React · Node.js'],
  services: {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { num: '03', title: 'Launch and grow', desc: "Your product is delivered and deployed. We stay available for maintenance and evolution." },
    ],
  },
  reviews: {
  ...
  footer: {
    ...
    servicesList: ['Web & Mobile Solutions', 'Consulting', 'After-Sales Service', 'The Essentials'],
    email: 'contact@bloomarone.com',
    phone: '+237 652 209 175',
  ...
  form: {
    ...
    close: 'Close',
    services: ['Web & Mobile Solutions', 'Consulting', 'After-Sales Service', 'The Essentials', 'Other'],
  ...
  contact: {
    ...
    sub: "Whether you have a precise idea or just need advice, our team is here to guide you.",
  ...
  about: {
    ...
    values: [
      ...
      { icon: '🚀', title: 'Excellence', desc: 'Every project delivered with care, on time, training included.' },
    ],
